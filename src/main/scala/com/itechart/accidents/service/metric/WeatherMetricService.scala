...
import com.itechart.accidents.entity.{MergedData, WeatherEntity, WeatherForAccident}
import com.itechart.accidents.integration.ny.service.{DayPeriodService, WeatherMappingService}
