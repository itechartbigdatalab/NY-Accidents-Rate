...
import com.itechart.accidents.constants.GeneralConstants.{HASH_DIFFERENCE, MILLIS_IN_HOUR, MILLIS_IN_MINUTE}
import com.itechart.accidents.entity.WeatherForAccident
