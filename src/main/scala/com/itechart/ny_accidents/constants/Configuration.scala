...
object Configuration {
  ...
  lazy val FIRST_YEAR_FILE_PATH: String =
    s"${appConf.getString("file.inputPath")}${yearDifferenceMetricConfig.getString("input.years.first")}"
  lazy val SECOND_YEAR_FILE_PATH: String =
    s"${appConf.getString("file.inputPath")}${yearDifferenceMetricConfig.getString("input.years.second")}"
  lazy val FIRST_YEAR_VALUE: Int = yearDifferenceMetricConfig.getInt("values.first")
  lazy val SECOND_YEAR_VALUE: Int = yearDifferenceMetricConfig.getInt("values.second")
