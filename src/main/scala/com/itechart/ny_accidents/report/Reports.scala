...
class Reports {
  ...
  def generateReportStringFor4Fields[A, B, C, D](data: RDD[(A, B, C, D)]): Seq[Seq[String]] = {
    data.map(obj => Seq(obj._1.toString, obj._2.toString, obj._3.toString, obj._4.toString)).collect().toSeq
  }
